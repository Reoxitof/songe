...
// Note : les avatars de classe sont servis en local (public/image/classes/),
// car le serveur ne peut pas joindre static.ankama.com (sorties bloquées).

// Toutes les routes ci-dessous exigent l'authentification.
