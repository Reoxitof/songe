...
function classAvatarUrl(cls) {
  ...
  // Portraits officiels hébergés en local (le serveur ne peut pas joindre
  // Ankama : requêtes sortantes bloquées). Fallback SVG si le fichier manque.
  return id ? `image/classes/${id}.jpg` : '';
}
